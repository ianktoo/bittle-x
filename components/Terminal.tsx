...
const Terminal: React.FC<TerminalProps> = ({ logs, onClear, onCommand }) => {
  ...
  if (!isOpen) {
    return (
      <button 
        ...
        className="w-full flex items-center justify-center gap-2 p-3 bg-slate-900/50 hover:bg-slate-800 rounded-xl border border-slate-700 text-slate-400 text-sm font-mono transition-all"
      >
  ...
  return (
    <div className="flex flex-col h-[400px] bg-slate-950 border border-slate-700 rounded-xl overflow-hidden shadow-2xl">
